...
def get_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--count", type=int, default=None, help="锚点档位数 3/6/9（默认取 config.anchor_defaults.anchor_count）")
...
def run(args: argparse.Namespace) -> None:
    ...
    print("请放置分割图后重跑校验：perfect.png 为首档，worst.png 为末档，中间档见 anchor.json 的 file 字段")
