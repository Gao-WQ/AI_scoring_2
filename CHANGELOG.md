...
版本口径说明：本文件编号为**代码演进版本**（v1→v2→v3→v3.1→v4→v5…，逐版对应 git commit）；设计文档《AI预打分方案》独立编号，自代码 v3 起方案号恒比代码号大 1（代码 v3↔方案 v4、v4↔方案 v5、v5↔方案 v6）。即最新代码版 v5 对应《AI预打分方案_v6.docx》。
...
- 日期：2026-09-02
- 对应方案：`AI预打分方案_v6.docx`（方案号恒比代码号大 1，口径见文件头说明）
...
## v3.1（commit `8ac290e`）— 输入输出后缀可配置 + 运行时打印与进度条
